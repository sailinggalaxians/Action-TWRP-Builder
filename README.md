...
| `DEVICE_TREE_URL`    | Device address                                    | https://github.com/exynos-republic/android_device_samsung_o1s         |
| `DEVICE_TREE_BRANCH` | Device branch                                     | fourteen                                                 |
| `DEVICE_PATH`        | Device location                                   | device/samsung/o1s                                            |
| `COMMON_TREE_URL`    | Common tree address                               | https://github.com/exynos-republic/android_device_samsung_universal2100-common |
| `COMMON_PATH`        | Common tree location                              | device/samsung/universal2100-common                                    |
| `DEVICE_NAME`        | Model name                                        | o1s                                                        |
| `MAKEFILE_NAME`      | Makefile name                                     | twrp_o1s                                                   |
